...
if (forecast['yhat1'][forecast.index[-1]]>data['Close'][size]):
    st.write('The predicted price will be higher than the current price')
    price = forecast['yhat1'][forecast.index[-1]]-data['Close'][size]
...
elif (forecast['yhat1'][forecast.index[-1]]<data['Close'][size]):
    st.write('The predicted price will be lower than the current price')
    price = data['Close'][size]-forecast['yhat1'][forecast.index[-1]]
